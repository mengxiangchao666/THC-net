...
def plot_confusion_matrix(experiment, targets, predicts, img_path, title="Confusion Matrix", save_fig=True):
	from sklearn.metrics import confusion_matrix
	import seaborn as sns
	import matplotlib.pyplot as plt

	# 将概率转换为0/1类别
	binary_preds = [1 if p > 0.5 else 0 for p in predicts]
	...
	sns.heatmap(cm, annot=True, fmt='d', cmap='Blues',
				xticklabels=['B-compartment', 'A-compartment'],
				yticklabels=['B-compartment', 'A-compartment'])
	plt.title(title)
